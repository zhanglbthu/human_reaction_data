...
def get_parser():
    ...
    parser.add_argument(
        '--model_name',
        type=str,
        default='/root/autodl-tmp/checkpoints/CogVideoX-Fun-V1.1-5b-InP',
    ...
    parser.add_argument(
        '--transformer_path',
        type=str,
        default="/root/autodl-tmp/checkpoints/TrajectoryCrafter",
    ...
    parser.add_argument('--blip_path', type=str, default="/root/autodl-tmp/checkpoints/blip2-opt-2.7b")
    ...
    parser.add_argument(
        '--unet_path',
        type=str,
        default="/root/autodl-tmp/checkpoints/DepthCrafter",
    ...
    parser.add_argument(
        '--pre_train_path',
        type=str,
        default="/root/autodl-tmp/checkpoints/stable-video-diffusion-img2vid",
